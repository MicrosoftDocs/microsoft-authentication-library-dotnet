...
- In the other cases of [web apps](/azure/active-directory/develop/scenario-web-app-call-api-overview) and [web APIs](/azure/active-directory/develop/scenario-web-api-call-api-overview):
 ...
 - If you  want to use an in-memory token cache and control its size and eviction policies, use the [Microsoft.Identity.Web in-memory cache option](token-cache-serialization?tabs=aspnet#in-memory-token-cache-1).
