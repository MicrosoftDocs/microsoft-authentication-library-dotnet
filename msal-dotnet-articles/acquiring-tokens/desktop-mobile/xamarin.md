---
title: Using MSAL.NET With Xamarin
---

# Using MSAL.NET With Xamarin

- [How to configure brokers for Xamarin apps for use with Intune](/azure/active-directory/develop/msal-net-use-brokers-with-xamarin-apps)
