...
> Service Fabric requires a certificate validatidation which is supported [4.62.0](https://github.com/AzureAD/microsoft-authentication-library-for-dotnet/blob/main/CHANGELOG.md#4620) onwards. The validation is available for Net 4.7.1 and greater, Net Standard and Net Core.
