...
- The same principles apply to Web Applications, though given you are in a browser you must leverage a browser which can “talk to” WAM (that is either Edge on Chromium or Chrome with the Azure AD extensions. For details see [Conditional access conditions | Chrome support](/azure/active-directory/conditional-access/concept-conditional-access-conditions#chrome-support)