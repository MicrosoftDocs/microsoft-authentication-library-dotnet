...
## Metrics
See information about MSAL-provided metrics in [token cache documentation](https://docs.microsoft.com/azure/active-directory/develop/msal-net-token-cache-serialization?tabs=aspnetcore#monitor-cache-hit-ratios-and-cache-performance).